...
Second, you can **use R and RStudio on University computers**. All University computers have access to R and RStudio, via the AppsAnywhere service. Again, you should first install R (which, at the time of writing, is confusingly included under the name "CRAN") via AppsAnywhere, and then install RStudio via AppsAnywhere.
...
Third, you can **use the [RStudio Cloud](https://rstudio.cloud/)**. The RStudio Cloud is a cloud-hosted "Google Docs for R" that you can use through your web browser -- you can get 25 hours per month for free, which should be plenty for this module, or pay for more.
