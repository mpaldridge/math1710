...
* If you want to use R/RStudio on a non-University device for which you don't have admin/installation rights (Chromebook, iPad, friend's laptop, etc), you could try:
   * You can use the University's copies of R/RStudio virtually through the [Windows Virtual Desktop (Academic)](https://it.leeds.ac.uk/it?id=kb_article&sysparm_article=KB0014379) or [AppsAnywhere](https://it.leeds.ac.uk/it?id=kb_article&sysparm_article=KB0014827) client.
   * The [RStudio Cloud](https://rstudio.cloud/) is a cloud-hosted "Google Docs for R" that you can use through your web browser -- you can get 25 hours per month for free, which should be plenty for this module.
