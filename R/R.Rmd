...
* If you want to use R/RStudio on a non-University device for which you don't have admin/installation rights (Chromebook, iPad, friend's laptop, etc), you could try:
   ...
   * The [RStudio Cloud](https://rstudio.cloud/) is a cloud-hosted "Google Docs for R" that you can use through your web browser -- you can get 15 hours per month for free (or pay for more).
