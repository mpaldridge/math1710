...
*Update:* If you have an Intel-based Chromebook, then we have had success installing R and RStudio using [these instructions](https://levente.littvay.hu/chromebook/).
