...
*This R worksheet consists solely of assessed questions. The material for these questions recaps all of the R Worksheets on the course so far. The deadline for submitting your solutions to these questions is **Thursday 15 December at 1400** -- note that this is an earlier deadline than usual.*
...
where `xy` is the last two digits of your Student ID. Note that the file name is `R3-xy.csv`, with a number `3`.
