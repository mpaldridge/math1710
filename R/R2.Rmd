...
Notice that in the second and third example examples we put a vector (`c(2, 4)` and then `1:3 = c(1, 2, 3)`) into the square brackets to pull out multiple entries of the vector.
...
*You should submit your work by typing your answers into [this Microsoft Form](https://forms.office.com/Pages/ResponsePage.aspx?id=qO3qvR3IzkWGPlIypTW3ywARQdZlKXRHsLcXi_ngX8NURUJBT080Mks5NkVNRzhMQldDMFBLNUkxVy4u). You may need to log into your University account.*
...
**First**, run the following code *exactly*. I strongly recommend copy-pasting diremb
