...
> **Assessed Question 2.** *Let $X_2 \sim \text{Bin}(n,p)$, where $n = 200 + i$ and $p = (i+10)/20$, where $i$ is the final digit of your Student ID number. What is $\mathbb P(X_2 > 3)$? Round your answer to three significant figures.*
...
> **Assessed Question 5.** *Let X_5 \sim \text{Po}(\lambda)$, where $\lambda = (1 + i)/2$ What is $\mathbb P(X_5 \text{ is even})$? Round your answer to five decimal places.*
