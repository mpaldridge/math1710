...
The law of large numbers tells us this mean should get close to $\mathbb EX = 1/\lambda = 10$ as $n$ gets big. When I ran this code, I got `r mean(samples)` -- but because the code involves sampling a random variable, you will get a slightly different answer to me (and get a different answer each time you run it).
...
It can help to picture the convergence of $\overline X_n$ to the expectation by drawing a plot of the means
...
*You can now progress to [R Worksheet 10](https://mpaldridge.github.io/math1710/R10-2324.html).*