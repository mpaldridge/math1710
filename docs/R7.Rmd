...
> **(a)** $\mathbb P(X = 20)$ to two significant figures;\
> **(b)** $\mathbb P(X \geq 10)$.\
...
*The following five assessed questions should be submitted to the Microsoft Form that is linked to on the Minerva page for this module. I recommend you do this in Week 7, but the official deadline is **Monday 15 November at 1400**.*
...
> **Assessed Question 1.** Let $X_1 \sim \text{Bin}(n ,p)$, where $n = 20 + i$ and $p = (1 + i)/20$, where $i$ is the final digit of your Student ID number. What is $\mathbb P(X_1 \geq 5)$? Round your answer to four decimal places.

> **Assessed Question 2.** Let $X_2 \sim \text{Bin}(n,p)$, where $n = 200 + i$ and $p = (5 + i)/20$, where $i$ is the final digit of your Student ID number. What is $\mathbb P(X_2 \text{ is even})$? Round your answer to two significant figures.

> **Assessed Question 3.** Let $X_3 \sim \text{Bin}(n,p)$, where $n = 200 + i$ and $p = (1 + i)/100$, where $i$ is the final digit of your Student ID number. Let $Y_3$ be the Poisson approximation to $X_3$. What is $\mathbb P(Y_3 \leq 10)$? Round your answer to three significant figures.
