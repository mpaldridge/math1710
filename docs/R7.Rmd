...
> **Assessed Question 1.** Let $X_1 \sim \text{Bin}(n ,p)$, where $n = 20 + i$ and $p = (1 + i)/20$, where $i$ is the final digit of your Student ID number. What is $\mathbb P(X \geq 5)$? Round your answer to four decimal places.

> **Assessed Question 2.** Let $X_2 \sim \text{Bin}(n,p)$, where $n = 200 + i$ and $p = (5 + i)/20$, where $i$ is the final digit of your Student ID number. What is $\mathbb P(X \text{ is even})$? Round your answer to two significant figures.
