...
\[ \mathbb P(A) = \frac{|A|}{|\Omega|} , \]
is indeed a probability measure, in that is satisfies the three axioms in Definition XXXXXXXX.
\end{theorem}
