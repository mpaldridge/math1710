...
\textbf{(a)} Total numbers of Skittles colours in a large packet of six mini-packets:
...
Question C1 is a ``short question'', where showing brief working is sufficient; Question C2 is a ``long question'' that requires full sentences and very clear explanations. If you get stuck, your tutor may be willing to give you a little hint in your tutorial.
