...
\tightlist
\item
  \textbf{Mondays} at 1200 or at 1500, in \href{https://students.leeds.ac.uk/rooms?type=room\&id=99879}{Chemistry West LT F}
\item
  \textbf{Wednesdays} at 1500 in \href{https://students.leeds.ac.uk/rooms?type=room\&id=99879}{Chemistry West LT F} or at 1600 in \href{https://students.leeds.ac.uk/rooms?type=room\&id=100044}{Roger Stevens LT 20}
\end{itemize}

Check your timetable to see which lecture you are assigned to each day.
...
\includegraphics{math1710_files/figure-latex/unnamed-chunk-9-1.pdf}
...
The next four questions are \textbf{long questions}, which are intended to be harder. Long questions often require you to think originally for yourself, not just directly follow procedures from the notes. You may not be able to solve all of these questions, although you should make multiple attempts to do so. Here, your answers should be written in complete sentences, and you should carefully explain in words each step of your working. Your answers to these questions -- not only their mathematical content, but also how to write good, clear solutions -- are likely to be the main topic for discussion in your tutorial.
