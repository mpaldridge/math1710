...
\textbf{A1.} Consider again the ``number of Skittles in each packet'' data from Example ?????.
...
\textbf{(d)} Out of (b) and (c), which calculation was easier, and why?

\textbf{A2.} Consider the following data sets of the age of elected politicians on a local council.
...
\textbf{(a)} Six packets of Skittles are opened together, and the total number of sweets of each number is:
...
\midrule
\endhead
1 & \href{https://mpaldridge.github.io/math1710/R1.html}{R basics} & --- \\
