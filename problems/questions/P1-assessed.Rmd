...
::: {.myanswers data-latex=""}
*Hint.*
In Subsection 1.3 of the notes, we went from the definitional formula for the sample *variance* to a computational formula. Can you follow a similar argument here?
:::
::::
