...
:::: {.subq}
**(c)** Calculate (the standard approximation of) the mean age of the politicians.
...
:::: {.myq}
**3.** Consider the two datasets illustrated by the boxplots below. Write down some differences between the two datasets.

```{r two-boxplots, echo = FALSE}
set.seed(6)
x <- rnorm(80, 10, 2)
y <- 8 + rexp(80,0.4)
