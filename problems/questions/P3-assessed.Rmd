...
* $\mathbb P(J \mid L) = 0.01$, because the filter incorectly sends 1% of legitimate emails to my junk folder.
...
**Marks.** Up to 4 marks for mathematical accuracy. You can probably award all 3 marks if the answer at the end is correct, 3 for the right idea but a minor error, 1 or 2 marks for some progress.
