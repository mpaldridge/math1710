...
::: {.myanswers data-latex=""}
*Hint.* I recommend using the computational formula. Can you find $\mathbb EX_n^2$.
:::
::::

:::: {.subq}
**(c)** Let $Y$ be a discrete uniform distribution on $a+b-1$ values $\{a, a+1, a+2, \dots, b-1, b\}$, for integers $a$ and $b$ with $a<b$. Using parts (a) and (b), but without calculating any sums directly, find the expectation and variance of $Y$.
