...
::: {.myanswers data-latex=""}
*Solution.* Let us first note that $\mathbb P(A) = \mathbb P(B) = \frac36 = \frac12$. It's also the case that $\mathbb P(C) = \frac{18}{36}$, for example by counting the even outcomes out of the 36 equally likely possibilities.
