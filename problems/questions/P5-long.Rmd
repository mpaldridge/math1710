...
::: {.myanswers data-latex=""}
*Solution.*  The half-life is the solution $x$ to
...
::: {.myanswers data-latex=""}
*Solution.* The conditional distribution is
...
Write $\mu$ for the *true* expectation and $\sigma^2$ for the *true* variance of the population distribution $X$. Then the amount of data that is within two true-standard-deviations of the true-expectation is
