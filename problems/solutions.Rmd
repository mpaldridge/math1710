...
<!--
```{r, child = "problems/questions/P1-long-new.Rmd"}
```
-->
## Problem Sheet 2 {#P2-solutions .unnumbered}

### A: Short questions {#P2-short-solutions .unnumbered}

```{r, child = "problems/questions/P2-short.Rmd"}
```

### B: Long questions {#P2-long-solutions .unnumbered}
...
### A: Short questions {#P3-short-solutions .unnumbered}

```{r, child = "problems/questions/P3-short.Rmd"}
```

### B: Long questions {#P3-long-solutions .unnumbered}
...
### A: Short questions {#P4-short-solutions .unnumbered}

```{r, child = "problems/questions/P4-short.Rmd"}
```

### B: Long questions {#P4-long-solutions .unnumbered}
...
### A: Short questions {#P5-short-solutions .unnumbered}

```{r, child = "problems/questions/P5-short.Rmd"}
```

### B: Long questions {#P5-long-solutions .unnumbered}
