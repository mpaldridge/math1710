...
Finally, we see that
\[ \mathbb P(A) = 1 - \mathbb P(A^\comp) = 1 - \frac{|A^\comp|}{|\Omega|} = 1 - \frac{5^5}{6^5} = \frac{4651}{7776} \approx 0.598 .\]
So there's about a 60% chance we get at least one 6.
:::
