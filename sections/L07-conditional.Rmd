...
::: {.example}
*I roll a single dice dice. Let $A = \{\text{even number}\} = \{2,4,6\}$ be the event I roll an even number, and let $B = \{\text{at least 4}\} = \{4,5,6\}$ be the event I roll at least 4. Are the events $A$ and $B$ independent?*
