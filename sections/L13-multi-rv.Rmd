...
::: {.example}
*Let $X_1, X_2, \dots, X_{20}$ be IID random variables following a binomial distribution with parameters $n = 10$ and $p = 0.3$. What is the probability that all 20 of the the $X_i$ are nonzero?*
<!--
...
* [Stirzaker, *Elementary Probability*](https://leeds.primo.exlibrisgroup.com/permalink/44LEE_INST/13rlbcs/alma991013131349705181), Sections 5.1 and 5.2.
* [Grimmett and Welsh, *Probability*](https://leeds.primo.exlibrisgroup.com/permalink/44LEE_INST/13rlbcs/alma991002938669705181), Section 3.1 and 3.3.
