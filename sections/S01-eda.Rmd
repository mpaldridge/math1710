...
```{r boxplot1, cache = TRUE, echo = FALSE}
set.seed(3)
x <- c(rnorm(200), rnorm(40, 0.2, 2.2))
boxplot(x)
...
text(1.2, -3.1, "min. non-outlier", pos = 4)
text(1.2, 2.7, "max. non-outlier", pos = 4)
```
...
```{r hist-bins, cache = TRUE, fig.show="hold", out.width="48%"}
